...
import { forecastFor, type NationalState } from "@/lib/aegis/engine";
...
function ResourceDetail() {
  ...
  if (isLoading || !state) {
    return (
      <ConsoleShell breadcrumb={`Nation > ${cap(resource)}`} pulse={{ stockRisk: 0, bedRisk: 0, staffRisk: 0 }}>
        <LoadingState />
      </ConsoleShell>
    );
  }
